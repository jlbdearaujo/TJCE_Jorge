...
if paginaseleciona=='Execução de Título Extrajudicial':
	...
	if selemv!='NONE':
		...
		ax.set_xlim(0,Jorge159[Jorge159['ORIGEM']==selemv]['DTIN'].max()/2.0)
		...
		if selemv2!='NONE':
			...
			ax1.set_xlim(0,Jorge159[Jorge159['ORIGEM']==selemv2]['DTIN'].max()/2.0)
...
if paginaseleciona=='Execução Fiscal':
	...
	if selemv!='NONE':
		...
		ax.tick_params(axis="y", labelsize=20)
		ax.set_xlabel(r'$\Delta T$',fontsize=20)
		ax.set_xlim(0,Jorge1116[Jorge1116['ORIGEM']==selemv]['DTIN'].max()/2.0)
		ax.set_title(selemv,fontsize=20)
		...
		if selemv2!='NONE':
			...
			ax.set_xlim(0,Jorge1116[Jorge1116['ORIGEM']==selemv2]['DTIN'].max()/2.0)
...
if paginaseleciona=='Procedimento do Juizado Especial Cível':
	...
	if selemv!='NONE':
		...
		ax.tick_params(axis="y", labelsize=20)
		ax.set_xlabel(r'$\Delta T$',fontsize=20)
		ax.set_xlim(0,Jorge436[Jorge436['ORIGEM']==selemv]['DTIN'].max()/2.0)
		ax.set_title(selemv,fontsize=20)
		...
		if selemv2!='NONE':
			...
			ax.set_xlim(0,Jorge436[Jorge436['ORIGEM']==selemv2]['DTIN'].max()/2.0)
			ax.set_title(selemv2,fontsize=20)
